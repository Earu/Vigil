...
const api: IElectronAPI = {
	...
	purgeBackups: (filePath) => ipcRenderer.invoke('purge-backups', filePath),
	listConflictCopies: (vaultPath) => ipcRenderer.invoke('list-conflict-copies', vaultPath),
	vaultFolderAccess: (vaultPath) => ipcRenderer.invoke('vault-folder-access', vaultPath),
	requestVaultFolderAccess: (vaultPath) => ipcRenderer.invoke('request-vault-folder-access', vaultPath),
	...
	saveKeyFile: (name, data) => ipcRenderer.invoke('save-key-file', name, data),
	...
	getBiometricsConfig: () => ipcRenderer.invoke('get-biometrics-config'),
	setBiometricsConfig: (config: { requirePasswordAfterRestart: boolean }) => ipcRenderer.invoke('set-biometrics-config', config),
	...
	yubikeyOathOffer: () => ipcRenderer.invoke('yubikey-oath-offer'),
	yubikeyOathKeys: () => ipcRenderer.invoke('yubikey-oath-keys'),
	yubikeyOathAccounts: (serial, password) => ipcRenderer.invoke('yubikey-oath-accounts', serial, password),
	yubikeyOathCode: (serial, id, password) => ipcRenderer.invoke('yubikey-oath-code', serial, id, password),
	yubikeyOathPush: (serial, request, secret, password) => ipcRenderer.invoke('yubikey-oath-push', serial, request, secret, password),
	...
	sshAgentStatus: () => ipcRenderer.invoke('ssh-agent-status'),
	sshAgentInspectKey: (data, passphrase) => ipcRenderer.invoke('ssh-agent-inspect-key', data, passphrase),
	sshAgentAddKey: (data, passphrase, options) => ipcRenderer.invoke('ssh-agent-add-key', data, passphrase, options),
	sshAgentRemoveKey: (data, passphrase) => ipcRenderer.invoke('ssh-agent-remove-key', data, passphrase),
