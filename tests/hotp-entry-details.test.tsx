...
// the user just asked for must survive it. An otp field that does not parse
// must stay visible rather than vanish behind the dedicated OTP UI.
...
const GENERATE = 'Generate the next code, copy it and advance the counter';
...
describe('a HOTP entry in view mode', () => {
    ...
    it('generates, copies, saves the advanced counter and keeps the code through the refresh', async () => {
        ...
        expect(navigator.clipboard.writeText).toHaveBeenCalledWith('755224');
